...
entry2=Entry(pass_frame,bg="linen",fg="black",font=("Arial",20),bd=3,show="*")
entry2.pack(padx=10)
...
def btn_verify():
    ...
    if username=="" or password=="":
            messagebox.showerror("Error!","Print username and password")
            return 
    ...
    try:
        ...
        for line in data:
             user,pw,mob,em=line.strip().split(",")
        ...
        if found==True:
           ...
           messagebox.showinfo("Error","No user found")
